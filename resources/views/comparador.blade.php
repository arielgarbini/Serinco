...
<main>
                ...
                <div class="col-lg-12 text-center xs-text-center sm-text-center xs-margin-ten-top sm-margin-five-top">
                    ...
                    <form action="" method="" autocomplete="off" class="">
                        <div class="col-xs-12 col-sm-12 col-md-4 xs-no-padding sm-no-padding no-padding-left">
                            <label for="" class="xs-title-large sm-title-large input-numeral'">Ingreso mensual en pesos</label>
                            <input id="ingreso_mensual" name="" type="text" autocomplete="off" placeholder="Individual o familiar" min="14000" required>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 xs-no-padding sm-no-padding">
                            ...
                            <input id="edad" name="" type="number" autocomplete="off" placeholder="Cuántos años tenés" min="18" max="65" required>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 xs-no-padding sm-no-padding no-padding-right">
                            ...
                            <input id="plazo_solicitado" name="" type="number" autocomplete="off" placeholder="En años y hasta 30" min="1" max="30" required>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section id="pricing-table" style="display:none;">
        ...
        <div class="container">
            <div class="row animatedParent animateOnce" data-sequence="500" id="bank_list">
                <!--BANCO-->
                <?php
                $i = 0;
                ?>
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" class="">
                                    ...
                                    <p class="xs-text-small xs-no-margin-top sm-text-small md-text-small">Años del crédito</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="">
                            ...
                            <tr>
                                <td colspan="2" class="hidden">
                                    <a data-value="{{$bank->id}}" data-resul="" id="cuota_hidden_{{$bank->id}}" class="bank-selected btn btn-popsicle mpStartsSignup" data-location="Home - hero" data-text="Aplicar" data-style="Button - Popsicle" href="" data-toggle="modal" data-target="#SolicitarCredito">Ver más</a>
                                    <p class="xs-no-margin-top xs-text-extra-small sm-text-extra-small md-text-extra-small lg-text-extra-small hidden">* Para este crédito se requiere <a href="" data-toggle="modal" data-target="#SolicitarCertificado">certificado de titularidad</a>.</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
