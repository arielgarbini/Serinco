...
<html class="no-js" lang="es">
	<head>
        ...
        Desarrollado por CoffeeTalk Argentina. Encontranos en www.coffeetalk.com.ar
        Developed by CoffeeTalk Argentina. Find us at www.coffeetalk.com.ar  
        -->
        ...
        <meta property="og:url" content="http://www.serinco.com.ar/cf/noticia/{{$noticia->id}}">
        ...
        <meta name="twitter:image" content="{{asset('publicaciones/'.$noticia->big_pic)}}">
