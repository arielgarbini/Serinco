...
if(isset($_SESSION['login']) && $_SESSION['login']=='ok'){
	...
	<input type="text" placeholder="http://www.fuente.com.ar" name="fuente"  required> <br/>
	<label>Cuerpo</label><br/>
	<textarea rows="3" style="width: 456px; height: 50px;" name="cuerpo" id="larga"></textarea><br/>
